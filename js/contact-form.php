...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	//replying to the mail sent
	$e_subject2 = "tvtopseries Autogenerated Reply";
	$msg2 = "Thank you, $name, for visiting my website.";
	$headers2 = "From: $address" . PHP_EOL;
	$headers2 .= "Reply-To: $address" . PHP_EOL;
	...
	mail($email,$e_subject2,$msg2,$headers2);
